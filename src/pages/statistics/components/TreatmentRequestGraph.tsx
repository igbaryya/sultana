...
type Props = {
	totalTreatmentRequests: Record<'Y' | 'N', number>;
};

export function TreatmentRequestGraph({ totalTreatmentRequests }: Props) {
	...
	const data = {
		...
		datasets: [
			{
				label: '',
				data: [totalTreatmentRequests.Y, totalTreatmentRequests.N],
